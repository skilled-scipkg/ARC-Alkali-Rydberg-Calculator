# Evidence: arc-alkali-rydberg-calculator-math-and-io-primitives

## Primary docs
- `doc/math_and_io_primitives.rst`

## Primary source entry points
- `skills/arc-alkali-rydberg-calculator-math-and-io-primitives/references/doc_map.md`
- `arc/__init__.py`
- `arc/materials.py`
- `arc/wigner.py`
